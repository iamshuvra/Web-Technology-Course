...
<body>
   ...
   <li>Name :
   <input type="text" name="name" value="<?php echo $_SESSION["name"]; ?>" > </li>
  <li> Email : 
   <input type="email" name="email" value="<?php echo $_SESSION["email"]; ?>" > </li>
	<li>Gender: <br>
	<input type="radio" name="gender" value="male">male 
	<input type="radio" name="gender" value="female">female  </li>
<li>	DOB:
	   <input type="text" name="dob" value="<?php echo $_SESSION["dob"]; ?>" > </li>
